 ...
 * @author hkskogbe
 */
public class LisaaKirjaServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        request.setAttribute("kirjailijalista", kirjailijat.getKirjailijat());
        RequestDispatcher rd = request.getRequestDispatcher("LisaaKirja.jsp");
